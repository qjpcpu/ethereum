...
//
// Solidity: function decimals() constant returns(decimals uint8)
...
//
// Solidity: function name() constant returns(name string)
...
//
// Solidity: function symbol() constant returns(symbol string)
